...
class Ui_MainWindow(object):
    ...
    def __init__(self):
        self.dataLoaded = False #Set data as not
...
=====================  ====================\n""".format(*tuple(table_values)))
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.bac4_chk, self.growthfrom_input)
        ...
        MainWindow.setTabOrder(self.tempto_input, self.tempBtn)
        MainWindow.setTabOrder(self.tempBtn, self.display_window)
